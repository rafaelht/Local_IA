...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center px-4 py-12">
      <section className="w-full max-w-md rounded-3xl border border-slate-700 bg-slate-900/70 p-8 shadow-xl shadow-slate-950/30">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          ...
          <label className="block text-sm font-medium text-slate-200">Email o Nickname</label>
          <input
            value={email}
            ...
            placeholder="admin@local o admin"
            type="text"
            required
          />
